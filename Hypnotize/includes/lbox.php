...
//set $filename to "Modules/$module/left.php"
$filename = 'Modules/'.$module.'/left.php';
...
//set the file $filename to "Modules/$module/left.php"
$filename = 'Modules/'.$module.'/left.php';
//if the file $filename exists then
if (file_exists($filename)) {
//include the file
...
//else if $headline not is empty and $image not is empty and $allsites is like 0 and $dbsite is like $site and $position is like l then
}elseif (!empty($headline) && empty($image) && $allsites == "0" && $dbsite == $site && $position == "l") {
//print out the box
...
<td align="left" class="under2"><font size="1"><a href="'.$link.'" class="under2"><strong>'.$link.'</strong></a></font></td>
</tr>';};
print'</tbody>
</table>
</td>
